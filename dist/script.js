...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.toggleClass = function (clasNames) {
  for (let i = 0; i < this.length; i++) {
    if (!this[i].classList) {
      continue;
    }
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.post = async function (url, date) {
